...
Intelligent Fill preview tasks are tagged by case, layer, source revision, seed, bounds, scope, connectivity, and protection mode. Latest-only scheduling supersedes older previews; cancellation returns no applicable partial result.
